# Nihongo Trainer (Flutter / Android) — v1.2
...
app with swipe gestures and a customizable background (your own photo,
like a chat wallpaper).
...
## What's new in 1.2: sound, vibration, and a Sound settings section
